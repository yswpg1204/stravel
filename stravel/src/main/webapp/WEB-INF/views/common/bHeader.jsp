...
<div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          <a class="navbar-brand logo_h" href="../home.jsp"><img src="${pageContext.request.contextPath }/resources/img/logo.png" alt=""></a>
            ...
            <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#">공지사항</a>            
							...
							<li class="nav-item">
                <a href="#" class="nav-link" role="button" aria-haspopup="true"
                  aria-expanded="false">예약현황</a>
							</li>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">객실</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="#">객실등록</a></li>
                  <li class="nav-item"><a class="nav-link" href="#">객실수정</a></li>
                </ul>
							</li>
				<li class="nav-item">
                <a href="#" class="nav-link" role="button" aria-haspopup="true"
                  aria-expanded="false">사업자정보수정</a>
							</li>
